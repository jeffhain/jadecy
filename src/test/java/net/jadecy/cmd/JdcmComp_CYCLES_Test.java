...
public class JdcmComp_CYCLES_Test extends AbstractJdcmTezt {
    ...
    public void test_classes() {
        final String[] args = getArgs("-cycles");
    ...
    public void test_packages() {
        final String[] args = getArgs("-cycles" + " -packages");
    ...
    public void test_classes_minsize() {
        for (int minSize = -1; minSize <= 3; minSize++) {
            final String[] args = getArgs("-cycles" + " -minsize " + minSize);
    ...
    public void test_classes_minsize_maxsize() {
        for (int minSize = -1; minSize <= 6; minSize++) {
            for (int maxSize = -1; maxSize <= 6; maxSize++) {
                final String[] args = getArgs("-cycles" + " -minsize " + minSize + " -maxsize " + maxSize);
    ...
    public void test_classes_maxsize_noOrHugeLimit() {
        for (int maxSize : new int[]{-1,Integer.MAX_VALUE}) {
            final String[] args = getArgs("-cycles" + " -maxsize " + maxSize);
    ...
    public void test_classes_maxcount_noOrHugeLimit() {
        for (long maxCount : new long[]{-1L,Long.MAX_VALUE}) {
            final String[] args = getArgs("-cycles" + " -maxcount " + maxCount);
    ...
    public void test_classes_maxcount_0() {
        final String[] args = getArgs("-cycles" + " -maxcount 0");
    ...
    public void test_classes_maxcount_1() {
        final String[] args = getArgs("-cycles" + " -maxcount 1");
    ...
    public void test_classes_maxsize_2_maxcount_1() {
        final String[] args = getArgs("-cycles" + " -maxsize 2" + " -maxcount 1");
    ...
    public void test_packages_nocauses() {
        final String[] args = getArgs("-cycles" + " -packages" + " -nocauses");
    ...
    public void test_classes_nostats() {
        final String[] args = getArgs("-cycles" + " -nostats");
    ...
    public void test_packages_nostats() {
        final String[] args = getArgs("-cycles" + " -packages" + " -nostats");
    ...
    public void test_classes_onlystats() {
        final String[] args = getArgs("-cycles" + " -onlystats");
    ...
    public void test_packages_onlystats() {
        final String[] args = getArgs("-cycles" + " -packages" + " -onlystats");
    ...
    public void test_classes_dotformat() {
        final String[] args = getArgs("-cycles" + " -dotformat");
    ...
    public void test_packages_dotformat() {
        final String[] args = getArgs("-cycles" + " -packages" + " -dotformat");
